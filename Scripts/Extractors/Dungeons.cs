	...
	public class Dungeons : Extractor {
			...
			var data = new {
				...
				Random = dungeonSpawnTable.biomes.Select(group => {
					return new {
						...
						LegacyMinDistanceFromCore = group.legacyMinDistanceFromCore,
		...
		private object MapDungeon(GameObject gameObject) {
			...
			return new {
				...
				Seed = dungeonAuthoring.seed,
				Radius = dungeonAuthoring.radius,
				DontBlockOtherSpawns = dungeonAuthoring.dontBlockOtherSpawns,
